 ...
 * @author jgale
 */
public class Aeolian implements IScale {

    private Map<String, Double> tones;

    public Aeolian(double fundamentalHz) {
    ...
    public void generateScale(double fundamentalHz) {
        ...
        tones.put("6", fundamentalHz * Math.pow(2, 2.0 / 3.0));
    ...
    public String getName() {
        return "escala eólica o escala menor";
    }
